export default function Skills() {
  ...
  const backend = ["Node.js", "NestJS", "SQL",];

  const ferramentas = ["Git", "GitHub"];

  return (
    <section id="skills" className="px-6 py-28 bg-black">
        ...
        <div className="grid gap-8 lg:grid-cols-3">
          ...
          <div className="group rounded-3xl border border-white/10 bg-white/[0.03] p-8 backdrop-blur-xl transition duration-300 hover:-translate-y-2 hover:border-white/20 hover:shadow-[0_20px_80px_rgba(255,255,255,0.06)]">
            <div className="mb-8">
              ...
              <p className="mt-3 text-zinc-400">
                Construção de APIs, organização da lógica do sistema e integração
                com banco de dados.
              </p>
            </div>
          ...
          <div className="group rounded-3xl border border-white/10 bg-white/[0.03] p-8 backdrop-blur-xl transition duration-300 hover:-translate-y-2 hover:border-white/20 hover:shadow-[0_20px_80px_rgba(255,255,255,0.06)]">
            <div className="mb-8">
              ...
              <p className="mt-3 text-zinc-400">
                Recursos que ajudam na organização, versionamento e evolução dos
                projetos.
              </p>
            </div>
